...
!     icalen MUST be == zero  if IPRINT == 3 to print subdaily;
      ...
      open (10086,file='lwx_flow_no3.out')!!  李玮翔修正输出文件
      write (173,5102) 'HRU','YEAR','DAY','Flow_go', 'Flow_accept','NO3_go','orgn_go'
      open (10086001,file='lwx_irr.out')!!  李玮翔修正输出文件
      write (10086001,5102) 'HRU','YEAR','DAY','irr'
